...
export default function SearchBox(props: { setOpenSearch: (open: boolean) => void, openSearch: boolean }) {
  ...
  return (
    <Transition.Root show={props.openSearch} as={Fragment} afterLeave={() => setRawQuery('')} appear>
      <Dialog as="div" className=" z-10" onClose={props.setOpenSearch}>
        <Transition.Child
          as={Fragment}
        ...
        <div className="fixed inset-0 z-10 w-screen flex items-center justify-center h-screen overflow-y-auto p-4 sm:p-6 md:p-20">
          <Transition.Child
            as={Fragment}
            enter="ease-out duration-300"
          ...
          >
            <Dialog.Panel className="mx-auto max-w-2xl transform divide-y divide-gray-100 overflow-hidden rounded-xl bg-white shadow-2xl ring-1 ring-black ring-opacity-5 transition-all">
              <Combobox onChange={(item: SearchItem) => (window.location.href = item.url)}>
